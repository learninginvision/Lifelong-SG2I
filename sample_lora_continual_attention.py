...
print(sys.path)
#sys.path.remove("/data/gxh/continual-diffusion/stable-diffusion")
                ...
                for prompts in tqdm(data, desc="data"):
                    ...
                    for n in trange(opt.n_iter, desc="Sampling"):
                        ...
                        if opt.task_prompt is not None:
                            region_prompts=opt.task_prompt
                            print(region_prompts)
                            c_gate = model.get_learned_conditioning(region_prompts)
                        else:
                            c_gate=None
                        #print(c_gate)
                        #c_gate_np=torch.mean(c_gate,dim=1)
                        #loss1=torch.norm((c_gate_np[0]-c_gate_np[1]),p=2)
                        #print(loss1)
                        #position=[0,1]
                        #c_gate=None
                        position=None
                        #position=model.cond_stage_model.position
