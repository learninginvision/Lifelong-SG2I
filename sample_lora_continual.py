...
def load_model_from_config(config, ckpt, verbose=True):
    ...
    if model.lora_type=="lora":
                ...
                lora_params, _ = inject_trainable_loraEC2_continual(model.model.diffusion_model,num_tasks=model.num_tasks,pool_size=model.num_tasks+1,r=model.rank,is_lora_KV =lora_KV)
            ...
            with model.ema_scope():
                for prompts in tqdm(data, desc="data"):
                    ...
                    for n in trange(opt.n_iter, desc="Sampling"):
                        ...
                        c = model.get_learned_conditioning(prompts)#(77,768)
